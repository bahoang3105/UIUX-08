    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Tổng quan công việc UIUX_08 10-2021</strong>
            <CIcon
            ...
            <CCardBody>
              <CTable>
                ...
                <CTableBody>
                  ...
                  <CTableRow>
                    <CTableHeaderCell scope="row" style={{ textAlign: 'center' }}>UIUX_08</CTableHeaderCell>
                    <CTableDataCell style={{ textAlign: 'center' }}>4</CTableDataCell>
                    <CTableDataCell style={{ color: 'blue', textAlign: 'center' }}>
                      1
                    </CTableDataCell>
      ...
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Đóng góp công việc UIUX_08 10-2021</strong>
            <CIcon
              icon={cilChevronCircleDownAlt}
              href="#"
              onClick={(e) => {
      ...
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Tiến độ công việc UIUX_08 10-2021</strong>
            <CIcon
              icon={cilChevronCircleDownAlt}
              href="#"
              onClick={(e) => {
      ...
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Kết quả trung bình công việc UIUX_08 10-2021</strong>
            <CIcon
              icon={cilChevronCircleDownAlt}
              href="#"
              onClick={(e) => {
      ...
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Tải công việc đơn vị UIUX_08 10-2021</strong>
            <CIcon
              icon={cilChevronCircleDownAlt}
              href="#"
              onClick={(e) => {
      ...
      <CCol xs={12}>
        <CCard className="mb-1">
          <CCardHeader>
            <strong>Thống kê bấm giờ UIUX_08 10-2021</strong>
            <CIcon
              icon={cilChevronCircleDownAlt}
              href="#"
              onClick={(e) => {
